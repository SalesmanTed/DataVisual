function network_analyse()
{
	...
	function(returnedData, status) {
		if("success"==status)
		{
			...
			$("#result").empty();
			$("#result").append("<div id='chords' style='display:block;height:500px;width:100%;margin-bottom:5px;'></div>");
			drawChords();
			$("#result").append("<div id='network'  style='display:none;height:500px;width:100%;margin-bottom:5px;'></div>");			
			drawNetwork();
