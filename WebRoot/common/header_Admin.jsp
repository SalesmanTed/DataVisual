...
<div id="commonheader" class="content">
	...
	<div id='toolLogo'style="width:700px;       
		...
		left: 660px;">
		<ul id="ulid">
		<li><a class="tool" href="fileDatasetList"><img src="<%=path%>/resources/images/toolIcon/find.png"/></a></li>
		<li><a class="tool" href="database/backUp.jsp"><img src="<%=path%>/resources/images/toolIcon/backup.png"/></a></li>
		<li><a class="tool" href="database/revert.jsp" ><img src="<%=path%>/resources/images/toolIcon/revert.png"/></a></li>
		<li><a class="tool" href="user/regist.jsp" ><img src="<%=path%>/resources/images/toolIcon/regist.png"/></a></li>
		<li><a class="tool" href="user/update_Admin.jsp" ><img src="<%=path%>/resources/images/toolIcon/update.png"/></a></li>
