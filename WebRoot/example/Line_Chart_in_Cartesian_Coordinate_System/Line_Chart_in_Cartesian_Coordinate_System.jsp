...
<html>
  <head>
    <base href="<%=basePath%>">
		...
		<title>Line Chart in Cartesian Coordinate System</title>
  ...
  <body>
		...
		<script type="text/javascript" src="<%=path%>/example/Line_Chart_in_Cartesian_Coordinate_System/editor.js"></script>
