	...
	<div id="content_template" class="content">
		...
		<div id="main">
			...
			<div  class='tableList' style="width:50%;margin-left:30%;">
			    <div  class='key_s' style="position:relative;top:-120px">分析列选择：</div>
			    <div class="value_s">
					...
					<div style="display:inline-block;">
				        <select multiple="multiple" id="select2" style="width: 160px;height:160px;border: 1px solid #a0c3da;font-size: 20px;color: blueviolet;"
		    ...
		    <div class='tableList' style="width:50%;margin-left:30%;">
				    ...
				    <div class='value_s'>
				      <s:textfield id="center" name="center" value="3" data-step="4" data-intro="指定聚类数目" data-position="right" style="width:160px"></s:textfield>
				    </div>
		    </div>
		    ...
		    <div class='tableList' style="width:50%;margin-left:30%;">
				    ...
				    <div class='value_s'>
				      <s:textfield id="itermax" name="itermax" value="10" data-step="5" data-intro="设置最大迭代次数" data-position="right" style="width:160px"></s:textfield>
				    </div>
		    </div>
	...
	<script type="text/javascript">
			$(document).ready(function(){
				...
				*/
				...
				$("#outerWrap_image").css("right",0+"px");
			});
	</script>	
...
//	console.log(flowers);
	 ...
	 svg = d3.select("#parallelResult").append("svg:svg")
    ...
    <script type="text/javascript">
		function drawScatterMatrix(data){
			...
			var color = d3.scale.category20();
			  ...
			  var svg = d3.select("#scattermatrixResult").append("svg")
