	...
	<div id="content_template" class="content">
		...
		<div id="main">
			...
			<div  class='tableList' style="width:50%;margin-left:30%;" >
			    <div  class='key_s' style="position:relative;top:-120px;width: 180px">分析列选择：</div>
			    <div class="value_s">
				    <div style="display:inline-block;">
				        <select multiple="multiple" id="select1" style="width:160px;height:160px;border: 1px solid #a0c3da;font-size: 20px;color: royalblue;"
		    ...
		    <div class='tableList' style="width:50%;margin-left:30%;">
  				<div class='key_s' style="width: 180px">统计信息图类型：</div>
			    <div class='value_s'>
			      <select id="method" data-step="4" data-intro="选择你希望看到的统计图" style="width:160px">
