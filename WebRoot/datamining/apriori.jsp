...
<body>
			...
			<div class="tableSelect">
				<div  class='tableList' style="width:50%;margin-left:30%;">
				    ...
				    <div class="value_s">
						...
						<div style="display:inline-block;">
					        <select multiple="multiple" id="select2" style="width:160px;height:160px;border: 1px solid #a0c3da;font-size: 20px;color: royalblue;"
			   ...
			   <div class='tableList' style="width:50%;margin-left:30%;">
					    ...
					    <div class='value_s'>
					      <s:textfield id="lift" name="lift" value="0.1" data-step="4" data-intro="设置最小支持度" data-position="right" style="width:160px"></s:textfield>
					    </div>
			   </div>
			   ...
			   <div class='tableList' style="width:50%;margin-left:30%;">
					    ...
					    <div class='value_s'>
					      <s:textfield id="conf" name="conf" value="0.8" data-step="5" data-intro="设置置信度" data-position="right" style="width:160px"></s:textfield>
					    </div>
			   </div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			console.log((ksqy_hei-top_hei-bottom_hei-hei)/2.0+top_hei);
